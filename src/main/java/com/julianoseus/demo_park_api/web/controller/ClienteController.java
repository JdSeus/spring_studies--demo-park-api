...
public class ClienteController {
    ...
    @Operation(summary = "Criar um novo cliente", description = "Recurso para criar um novo cliete vinculado a um usuário cadastrado. Requisição exige uso de um bearer token. Acesso restrito a Role='CLIENTE'",
            responses = {
