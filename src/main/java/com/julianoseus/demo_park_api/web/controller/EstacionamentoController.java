package com.julianoseus.demo_park_api.web.controller;

import com.julianoseus.demo_park_api.entity.ClienteVaga;
import com.julianoseus.demo_park_api.jwt.JwtUserDetails;
import com.julianoseus.demo_park_api.repository.projection.ClienteVagaProjection;
import com.julianoseus.demo_park_api.service.ClienteService;
import com.julianoseus.demo_park_api.service.ClienteVagaService;
import com.julianoseus.demo_park_api.service.EstacionamentoService;
import com.julianoseus.demo_park_api.service.JasperService;
import com.julianoseus.demo_park_api.web.dto.EstacionamentoCreateDto;
import com.julianoseus.demo_park_api.web.dto.EstacionamentoResponseDto;
import com.julianoseus.demo_park_api.web.dto.PageableDto;
import com.julianoseus.demo_park_api.web.dto.UsuarioResponseDto;
import com.julianoseus.demo_park_api.web.dto.mapper.ClienteVagaMapper;
...
public class EstacionamentoController {
    ...
    @Operation(summary = "Operação de check-in", description = "Recurso para dar entrada de um veiculo no estacionamento. Requisição exige uso de um bearer token. Acesso restrito a Role='ADMIN'",
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "422", description = "Recurso não processado por falta de dados ou dados de entrada inválidos", content = @Content(mediaType = "application/json;charset=UTF-8", schema = @Schema(implementation = ErrorMessage.class
                    ))),
    ...
    @Operation(summary = "Operação de check-out", description = "Recurso para dar saída de um veiculo no estacionamento. Requisição exige uso de um bearer token. Acesso restrito a Role='ADMIN'",
            security = @SecurityRequirement(name = "security"),
            parameters = {
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "Número do recibo inexiste ou " +
