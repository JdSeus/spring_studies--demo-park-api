...
import com.julianoseus.demo_park_api.web.dto.UsuarioCreateDto;
import com.julianoseus.demo_park_api.web.dto.UsuarioResponseDto;
import com.julianoseus.demo_park_api.web.dto.UsuarioSenhaDto;
import com.julianoseus.demo_park_api.web.dto.mapper.UsuarioMapper;
...
public class UsuarioController {
    ...
    @Operation(summary = "Atualizar Senha", description = "Requisição exige um Bearer Token. Acesso restrito a ADMIN|CLIENTE",
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "Senhas não conferem", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class
                    ))),
                    @ApiResponse(responseCode = "403", description = "Usuário sem permissão para acessar este recurso", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class
                    ))),
    ...
    @Operation(summary = "Listar todos os usuários cadastrados", description = "Requisição exige um Bearer Token. Acesso restrito a ADMIN",
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "200", description = "Lista com todos os usuários cadastrados", content = @Content(mediaType = "application/json", array = @ArraySchema(
