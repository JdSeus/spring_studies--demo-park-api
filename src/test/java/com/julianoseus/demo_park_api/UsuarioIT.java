...
public class UsuarioIT {
    ...
    public void createUsuario_ComPasswordInvalido_RetornarErrorMessageStatus422() {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("teste@teste.com", "1234567"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void createUsuario_ComUsernameRepetido_RetornarErrorMessageComStatus409() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("altrano@email.com", "123456"))
                .exchange()
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("altrano@email.com");
       ...
       responseBody = testClient
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("beltrano@email.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.getRole()).isEqualTo("CLIENTE");
    ...
    public void editarSenha_ComSenhasInvalidas_RetornarErrorMessageComStatus400() {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("121212", "123456", "123456"))
                .exchange()
                .expectStatus().isEqualTo(400)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void listarUsuarios_SemQualquerParametro_RetornarListaDeUsuariosComStatus200() {
        List<UsuarioResponseDto> responseBody = testClient
                ...
                .exchange()
                .expectStatus().isOk()
                .expectBodyList(UsuarioResponseDto.class) // <-- aqui vai a classe
                .returnResult()
                .getResponseBody();
